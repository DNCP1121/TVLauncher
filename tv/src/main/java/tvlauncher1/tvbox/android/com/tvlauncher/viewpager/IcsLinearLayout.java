package tvlauncher1.tvbox.android.com.tvlauncher.viewpager;
...
/**
 * A simple extension of a regular linear qunzhu_btns that supports the divider API
 * of Android 4.0+. The dividers are added adjacent to the children by changing
 * their qunzhu_btns params. If you need to rely on the margins which fall in the
 * same orientation as the qunzhu_btns you should wrap the child in a simple
